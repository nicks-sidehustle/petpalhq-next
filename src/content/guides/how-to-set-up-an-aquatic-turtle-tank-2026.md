...
keywords:
  ...
  - "turtle basking dock and UVB"
  - "turtle canister filter setup"
  - "painted turtle aquarium setup"
  - "turtle tank heating and lighting"
...
picks:
  - rank: 1
    label: "SIZE THE WATER BODY — LARGE GLASS TANK"
    name: "Tetra 55-Gallon Glass Aquarium"
    brand: "Tetra"
    score: 8.7
    price: "$299.99"
    image: "https://m.media-amazon.com/images/I/41XOH+Kq1vL._SL500_.jpg"
    asin: "B08BJB7FX4"
    ...
    authoritySources:
      - outlet: "Tetra (Amazon product listing, 55 Gallon Glass Aquarium NV52018)"
        ...
        supports: "spec"
        accessed: "2026-07-12"
      - outlet: "Aquatic-turtle keeper community consensus on water volume"
        stat: "keepers size an aquatic turtle tank to the adult, not the hatchling, and the common rule of thumb is roughly ten gallons of water per inch of shell, so an adult slider needs a large tank measured in the dozens of gallons rather than the small kit a baby turtle is often sold in"
        supports: "general"
        accessed: "2026-07-12"
    keyFeatures:
    ...
    verdict: "Start here, and size to the adult turtle rather than the hatchling. Set it on a stand rated for the filled weight on a level, load-bearing floor, keep the water deep enough to submerge but never high enough to climb out, and treat this as the empty water body the filter, heat, and basking dock all attach to."

  - rank: 2
    label: "OVER-FILTER THE WATER — CANISTER FILTER"
    name: "PONDFORSE Canister Filter"
    brand: "PONDFORSE"
    score: 8.6
    price: "$62.99"
    image: "https://m.media-amazon.com/images/I/41ceLxf6x9L._SL500_.jpg"
    asin: "B0DCJ59TDZ"
    ...
    authoritySources:
      - outlet: "PONDFORSE (Amazon product listing, Canister Filter)"
        ...
        supports: "spec"
        accessed: "2026-07-12"
      - outlet: "Aquatic-turtle keeper consensus on over-filtering"
        stat: "turtles produce far more waste than fish of the same tank size, so keepers deliberately over-filter, choosing a filter rated for two to three times the actual water volume, because an underpowered in-tank or hang-on filter cannot keep turtle water clean and the tank fouls fast"
        supports: "general"
        accessed: "2026-07-12"
    keyFeatures:
    ...
    verdict: "Over-filter deliberately — pick a canister rated well beyond the water volume, because a turtle fouls water far faster than fish do. Baffle the return so a weak swimmer is not shoved around, clean the media on a schedule, and treat it as a reducer of water changes, not a replacement for them."

  - rank: 3
    label: "BUILD THE DRY DOCK — ABOVE-TANK BASKING PLATFORM"
    name: "LYL Turtle Topper Above-Tank Basking Platform"
    brand: "LYL LEYOULAND"
    score: 8.4
    price: "$69.90"
    image: "https://m.media-amazon.com/images/I/41YUBMk6WkL._SL500_.jpg"
    asin: "B0DNS9TZRV"
    ...
    authoritySources:
      - outlet: "LYL LEYOULAND (Amazon product listing, Turtle Topper Basking Platform)"
        ...
        supports: "spec"
        accessed: "2026-07-12"
      - outlet: "Aquatic-turtle keeper consensus on basking area"
        stat: "aquatic turtles must be able to leave the water and dry out completely under heat and UVB, so keepers give every turtle a dry basking dock, and an above-tank platform is favored because it adds basking room without stealing swimming volume from the water below"
        supports: "general"
        accessed: "2026-07-12"
    keyFeatures:
    ...
    verdict: "Give the turtle a dry dock it can actually reach and cannot escape, and mount it above the tank so basking room does not cost swimming room. Match it to your rim, keep the water level safe below it, and remember the dock only earns its place if the lights above dry the turtle completely."

  - rank: 4
    label: "DRIVE THE BASKING SPOT — HEAT LAMP FIXTURE"
    name: "ReptiKing 5.5-Inch Reptile Dome Light Fixture"
    brand: "ReptiKing"
    score: 8.2
    price: "$18.89"
    image: "https://m.media-amazon.com/images/I/31mSFXYUw0L._SL500_.jpg"
    asin: "B0CWDR98FZ"
    ...
    authoritySources:
      - outlet: "ReptiKing (Amazon product listing, 5.5-Inch Reptile Light Dome)"
        ...
        supports: "spec"
        accessed: "2026-07-12"
      - outlet: "Aquatic-turtle keeper consensus on basking heat"
        stat: "a turtle basks to raise its body temperature and dry its shell, so keepers aim a basking bulb at the dock to create a warm dry spot noticeably hotter than the water, mounted in a heat-rated dome fixture positioned over the platform"
        supports: "general"
        accessed: "2026-07-12"
    keyFeatures:
  ...
  - rank: 5
    ...
    authoritySources:
      - outlet: "Zoo Med (Amazon product listing, ReptiSun 10.0 Mini Compact Fluorescent)"
        ...
        supports: "spec"
        accessed: "2026-07-12"
      - outlet: "Aquatic-turtle keeper consensus on UVB"
        stat: "turtles need UVB light to make vitamin D3 and metabolize calcium, without which they develop soft shells and metabolic bone disease, so keepers mount a dedicated UVB source over the basking dock separate from the heat lamp and replace it on schedule as its output fades"
        supports: "general"
        accessed: "2026-07-12"
    keyFeatures:
    ...
    verdict: "Fit a dedicated UVB bulb over the dock as the second basking light, never as an afterthought. Mount it close enough and with no glass or plastic between bulb and turtle, replace it on a six-to-twelve-month schedule as its output fades, and pair it with dietary calcium — UVB and diet prevent shell disease together."

  - rank: 6
    label: "WARM THE WATER — SUBMERSIBLE HEATER"
    name: "HiTauing Submersible Aquarium Heater"
    brand: "HiTauing"
    score: 8.0
    price: "$32.99"
    ...
    authoritySources:
      - outlet: "HiTauing (Amazon product listing, Submersible Aquarium Heater)"
        ...
        supports: "spec"
        accessed: "2026-07-12"
      - outlet: "Aquatic-turtle keeper consensus on water temperature"
        stat: "aquatic turtles are cold-blooded and need their water held in a stable, species-appropriate range rather than left to swing with the room, so keepers use a thermostatically controlled submersible heater sized to the tank volume and guard it against a turtle that may bump or crack it"
        supports: "general"
        accessed: "2026-07-12"
    keyFeatures:
  ...
  - rank: 7
    ...
    authoritySources:
      - outlet: "TetraFauna (Amazon product listing, AquaSafe for Reptiles and Amphibians)"
        ...
        supports: "spec"
        accessed: "2026-07-12"
      - outlet: "Aquatic-turtle keeper consensus on tap water"
        stat: "tap water carries chlorine and chloramine that irritate a turtle and harm the beneficial bacteria in the filter, so keepers condition every batch of new and replacement water before it goes in, treating it as a routine part of the water changes a turtle tank needs for life"
        supports: "general"
        accessed: "2026-07-12"
    keyFeatures:
    ...
    verdict: "Condition every batch of water, at setup and on every change for life. Dose it to the volume of new water so chlorine and chloramine are neutralized before they reach the turtle or the filter bacteria, and treat it as one ongoing step in water maintenance rather than a shortcut around filtration and water changes."

comparison:
  rows:
    - label: "Stage in the setup"
      values: ["Size the water body", "Over-filter the water", "Build the dry dock", "Drive the basking spot", "Add UVB", "Warm the water", "Condition the water"]
    - label: "When it comes into play"
      values: ["Before anything else", "Before stocking, running to cycle", "Before the lights", "Over the dock", "Over the dock", "Before stocking", "At fill and every change"]
    - label: "What it does"
...
methodology:
  formula: "PetPal Turtle-Readiness Score = (Expert Consensus × 0.35) + (Setup-Sequence Fit × 0.25) + (Turtle Health / Welfare Design × 0.20) + (Value × 0.20)"
  factors:
    - name: "Expert Consensus"
      weight: 35
      definition: "Synthesized from aquatic-turtle and chelonian keeper community consensus, published reptile-welfare and husbandry guidance on water volume, filtration, basking heat, UVB, and water temperature, and manufacturer documentation. The PetPal Turtle-Readiness Score is a composite of expert opinion — PetPalHQ does not run a testing lab."
    - name: "Setup-Sequence Fit"
      weight: 25
      definition: "How directly the item advances a correct aquatic-turtle build in order — sizing the water body, over-filtering the bioload, building a dry basking dock, driving the basking heat, adding UVB, warming the water, and conditioning it — rather than how it performs as a standalone product ranked against rivals."
    - name: "Turtle Health / Welfare Design"
      weight: 20
      definition: "Alignment with aquatic-turtle welfare principles — deep clean water sized to the adult, heavy filtration, a dry basking dock the turtle can reach and not escape, a warm basking spot, dedicated UVB, a stable water temperature gradient, and conditioned water. The turtle is stocked only after the tank is built and cycled."
    - name: "Value"
      weight: 20
      definition: "Cost relative to the item's role in the sequence, including ongoing costs like replacement UVB and basking bulbs, filter media, electricity, and conditioner, and how much of the healthy-turtle outcome the item is responsible for. This kit is the equipment cost, not the ongoing cost of keeping an aquatic turtle."
...
An aquatic turtle tank goes wrong, in this guide's editorial judgment, for one reason more than any other: it is set up like a fish tank with a turtle in it, instead of two habitats in one — a large, heavily filtered body of water and a warm, UVB-lit dry dock above it. A beginner buys the coin-sized hatchling and the small kit it is sold with, drops it in a shallow tank with a little filter and a light, and a year later has a fouling tank, a soft-shelled turtle, and an animal that has already outgrown its home. The tank was never sized for the animal the turtle becomes, and it was never built to do the two jobs an aquatic turtle needs done at once.
