...
**Is 5 gallons really enough for a betta fish?**

Five gallons is the accepted minimum volume for a single betta — the floor, not a target. The expert sources behind this guide treat anything smaller as an ammonia-management problem waiting to happen, because waste concentrates faster in less water. Shape matters alongside volume: bettas patrol horizontally, so a long, low tank like the Fluval Spec V serves the fish better than a vertical column of identical capacity. If space and budget allow, stepping up to the 9-gallon Fluval Flex nearly doubles the water volume, which slows parameter drift and makes beginner mistakes more survivable.

**Do 5-gallon aquarium kits come with a heater, and what size do I need?**

None of the four kits in this roundup includes a heater, and a betta cannot live safely without one. Bettas are tropical fish: Chewy's education material and PetMD's betta care sheet put safe water at 76 to 82 degrees Fahrenheit, with 78 to 80 ideal. The sizing rule is 3 to 5 watts per gallon, which lands a 5-gallon tank on a 15-to-25-watt nano heater — about $15 to $25. Add a thermometer to verify the heater holds its setpoint; an adjustable heater that drifts is a hazard you cannot see without one.

**How do I baffle a filter that is too strong for my betta?**
