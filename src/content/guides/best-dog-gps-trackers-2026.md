...
description: "Which dog GPS tracker actually finds a bolted dog — the Tractive with the fastest GPS lock and a $235 three-year cost, the Fi Series 3+ integrated collar with months of battery, the value Pawfit 3 with voice recall, or the health-monitoring Invoxia Minitailz. Four picks built on expert consensus from Wirecutter, PCMag, Reviewed.com, and five other outlets, with honest reporting on subscriptions, battery claims, and live-tracking lag."
...
picks:
  - rank: 1
    ...
    score: 9.0
    price: "$65.69"
    image: "https://m.media-amazon.com/images/I/51gnV5s8GuL._SL500_.jpg"
    asin: "B0D6Z74WJY"
    authoritySources:
  ...
  - rank: 4
    ...
    verdict: "The Minitailz is the specialist: buy it for cardiac and respiratory screening on a senior or at-risk dog. If lost-dog recovery is the primary job, its laggy live tracking argues for the Tractive instead."

comparison:
  headers: ["Product", "Price", "Pick category", "Lost-Dog Recovery Score"]
  rows:
    - ["Tractive GPS", "$65.69", "Best overall — fastest GPS lock", "9.0"]
