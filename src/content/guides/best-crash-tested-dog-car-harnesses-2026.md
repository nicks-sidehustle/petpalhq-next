...
excerpt: "For most drivers, the safest restraint is a Center for Pet Safety-certified harness or crate — Sleepypod's Clickit Sport Plus and the Gunner G1 are the editorial anchors, with Kurgo and EzyDog filling the FMVSS 213-tested middle and Sleepypod's Mobile Pet Bed covering the small-dog-and-cat slot."
category: "Cats & Dogs"
pillar: "expert-care"
...
picks:
  ...
  - rank: 2
    ...
    body: |
      ...
      The trade-off is price. At well over $150, the Mobile Pet Bed costs more than mainstream soft-sided carriers, but it is the only option in the small-pet slot with independent crash certification that PetPalHQ has been able to verify against CPS's published list.
    pros:
  ...
  - rank: 3
    ...
    body: |
      The Kurgo Enhanced Strength Tru-Fit is the budget answer for households that want crash-test methodology in the documentation but cannot stretch to the Sleepypod Clickit Sport Plus. Kurgo publishes its dog-harness crash-testing methodology, which references FMVSS 213-style procedures — the federal motor vehicle safety standard originally written for child restraint systems and adapted in the pet-restraint industry as the closest analogue.

      Kurgo says the Tru-Fit Enhanced Strength is rated to 75 lb. Above that weight, the manufacturer's guidance is to step up to the Impact harness (covered in the next pick). Below it, the Tru-Fit covers a meaningful slice of the dog population at roughly a third of the price of CPS-certified options.

      What the spec sheet does not tell you: Kurgo's testing is manufacturer-declared, not third-party-certified by CPS, and the AKC's car-safety guidance and Center for Pet Safety's broader advisories both treat manufacturer-declared crash testing as a step below independent certification. That is not the same thing as saying the harness is unsafe — it is saying the evidence stack is shorter. Hobbyist consensus on r/dogs reflects this: the Tru-Fit shows up routinely in "good budget option" threads, but the same threads tell people who can afford the upgrade to spend the extra money on a CPS-certified product.
  ...
  - rank: 4
    ...
    body: |
      The Kurgo Impact is the upgrade path for large dogs that exceed the Tru-Fit's 75 lb rating. Kurgo declares the Impact crash-tested to 108 lb under the same FMVSS 213-based methodology used for the Tru-Fit Enhanced Strength.

      Why this is the practical answer for big dogs: as of the Center for Pet Safety's published certification list, large-dog crash certification at the upper end of the weight range is thinner than at smaller sizes. CPS continues to update its certified list, but for buyers searching Amazon today, the Impact is the most credible large-dog harness with transparent crash-test methodology backing the marketing claim.

      What the spec sheet does not tell you: tubular webbing and steel buckles add weight and stiffness, and that is a feature, not a bug — but the same construction can be uncomfortable for a dog that is not used to a structured harness. Acclimation matters. AKC's Dog Car Safety guidance and AAHA's Traveling Safely With Your Pet brochure both note that any harness, certified or not, requires a few short trips before a long road trip so the dog is not fighting the harness when the seat belt finally clicks.
...
comparison:
  rows:
    - label: "Restraint type"
      values: ["Harness (3-point)", "Carrier as restraint", "Harness (5-point)", "Harness (5-point)", "Hard crate"]
    - label: "Independent certification"
      values: ["CPS 5-star", "CPS certified", "Manufacturer FMVSS 213-style", "Manufacturer FMVSS 213-style", "CPS 5-star"]
    - label: "Weight rating"
      values: ["Per size band", "Up to 15 lb", "Up to 75 lb", "Up to 108 lb", "Tested at 30 lb"]
    - label: "Best vehicle fit"
      values: ["Sedan to SUV back seat", "Sedan to SUV back seat", "Any vehicle back seat", "Any vehicle back seat", "SUV/truck cargo area"]
...
bottomLine:
  ...
  - "Get the Gunner G1 Small only if you have the vehicle space, the budget, and a containment use case. CPS-certified at five stars when anchored — and unanchored, even a Gunner is a projectile."
...
For most U.S. drivers, the safest dog car restraint is the one a third party has crash-tested and certified — and on that filter the field narrows fast. The Center for Pet Safety (CPS), an independent consumer-safety nonprofit, is the cleanest editorial cut between products with real evidence behind their claims and products selling on packaging copy alone. The American Kennel Club's Dog Car Safety guidance, the American Animal Hospital Association's Traveling Safely With Your Pet brochure, the American Veterinary Medical Association's travel guidance, and the Merck Veterinary Manual's Traveling by Car With Pets entry all converge on the same posture: anchored crates and CPS-certified harnesses are the gold standard, generic seat-belt clips and extension tethers are the failure modes to avoid.

The picks below are editorial synthesis. PetPalHQ does not run a crash-test lab — every product on this page was selected by reviewing CPS's certification records, manufacturer crash-testing documentation, AKC and AAHA travel guidance, and hobbyist consensus on r/dogs. Where evidence stacks differed (Sleepypod and Gunner have CPS certification; Kurgo and EzyDog publish their own FMVSS 213-style testing methodology but do not have third-party certification at the time of this writing), we say so explicitly in each pick.
