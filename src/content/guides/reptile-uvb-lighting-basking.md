...
keywords:
  ...
  - "T5 HO UVB bulb for reptiles"
  - "basking bulb vs UVB bulb"
  - "Arcadia reptile lighting"
  - "Zoo Med ReptiSun T5"
  - "mercury vapor bulb reptile"
  - "UVB bulb replacement schedule"
  - "leopard gecko UVB requirements"
  - "mesh screen UVB loss reptile"
...
guideType: "hub"
spokes: [best-reptile-uvb-bulbs-2026]
...
sources:
  expert:
    ...
    - "PubMed — Nutritional metabolic bone disease in juvenile veiled chameleons and its prevention (2010)"
  ...
  community:
    - "Arcadia Reptile — Lighting Guide, ProT5, Dragon, Forest, and Natural Sunlight lamp documentation"
    - "Arcadia Reptile — D3 Basking Lamp / D3 EVO Basking Lamp documentation"
    - "Arcadia Reptile — Ceramic Heater, Deep Heat Projector, Halogen Infrared Heater, Clamp Lamp, and Lamp Holder Bracket Pro documentation"
...
| Halogen / incandescent basking bulb | Heat, visible light, and often UVA — but **not UVB** | Daytime basking heat alongside a separate UVB lamp | Many beginners assume it replaces UVB; it does not | Arcadia halogen heat lamp documentation; VCA lighting article |
...
| Ceramic heat emitter (CHE) | Heat only — no visible light, no UVA, no UVB | Supplemental or nighttime heat where visible light would disrupt the day/night cycle | Cannot create a daytime basking effect or replace UVB | Arcadia Ceramic Heater documentation; VCA lighting article |

Compact UVB bulbs in particular deserve a word of warning. LafeberVet's technical PDF is direct that compact UVB creates a small coverage zone with a steep gradient — useful in genuinely small enclosures, but a poor default for the standard 40-gallon and larger setups most pet reptiles live in.
...
- Lit by overlapping UVB, visible light, and basking heat — three jobs, often two or three bulbs.
...
- The enclosure is unusually tall, screened, or shallow — situations where calculated distances and published distance charts may not match real delivery.
...
|---|---|---|---|---|
| Bearded dragon | High | Strong linear T5 HO UVB plus a separate halogen basking bulb; broad basking platform | Arcadia's Dragon lamp documentation uses an upper basking UVI around 6.0 at ~35–40 cm under its reflected lamp system | Arcadia Dragon lamp docs; Wageningen 2010 bearded dragon study |
| Leopard gecko | Low to moderate | Low-level linear UVB over one end with hides and shade; modest basking zone | Arcadia's Lighting Guide cites a basking UVI of roughly 2–3 fading to 0 at the cool end — a gradient, not blanket coverage | Arcadia Lighting Guide; Wageningen 2020 leopard gecko UVB study |
...
| Veiled and panther chameleon | Moderate | Linear UVB from above paired with a basking and daylight zone near upper perches; planted shade lower down | Behavioral studies (University of Chicago, 2009) show panther chameleons regulate their UV exposure — provide gradient, not flood | Arcadia Forest lamp docs; Journal of Zoo and Aquarium Research UV-Tool paper |
...
**Mounting lamps loosely or without guards.** Hot lamps can burn animals or fall into enclosures or water. Use rated holders, cages, clamps, and brackets — Arcadia's Clamp Lamp and Lamp Holder Bracket Pro documentation cover the specific failure modes.
...
**Q: Is a basking bulb the same thing as a UVB bulb?**
A: No. The Arcadia halogen heat lamp documentation and the VCA lighting article are direct on this: a basking bulb mainly provides heat and visible light, sometimes UVA, but it does **not** provide biologically useful UVB. Pair basking heat with a real UVB source, or use a manufacturer-spec'd mercury vapor bulb that delivers both.

**Q: Can I use an LED bar instead of UVB?**
A: Not as a default. LafeberVet's technical PDF and the VCA lighting article both treat standard LEDs as a visible-brightness solution, not a UVB substitute. UVB-LED products are an emerging category, but published research has raised safety concerns about their spectra, so they should not be presented as the beginner baseline.

**Q: Can UVB go through glass or a window?**
A: No, not in a useful way for husbandry. The LafeberVet technical PDF, the Merck *Providing a Home for a Reptile* chapter, and the VCA lighting article are all explicit: ordinary glass and most plastics block the UVB the keeper is trying to deliver. UVB has to reach the animal directly.

**Q: How close should the UVB bulb be?**
...
**Q: If my UVB bulb still looks bright, is it still good?**
A: Not necessarily. LafeberVet's technical PDF and the VCA lighting article both note that UVB output falls with use even when the bulb still appears normal to the human eye. Replace on schedule or verify with a UV meter.

**Q: Do leopard geckos need UVB?**
A: They should not be treated like bearded dragons, but the evidence supports UVB use. Wageningen University & Research's 2020 paper confirms that leopard geckos synthesize vitamin D3 from UVB exposure, and Arcadia's Lighting Guide gives example basking-UVI targets of roughly 2–3 for leopard geckos with the cool end at 0. Modern husbandry increasingly uses low-level UVB gradients for them — not the same lamp setup as a bearded dragon, but not zero either.

**Q: Should UVB stay on at night?**
A: No. UVB is a daytime input. The Merck *Providing a Home for a Reptile* chapter and Arcadia's heater documentation both treat night heat as a separate problem solved by lightless sources (ceramic heat emitters, deep heat projectors) when supplemental warmth is needed after dark.

**Q: When is a UV meter worth buying?**
A: A meter becomes especially valuable when the enclosure is tall, screened, unusually shallow, or expensive enough that replacing bulbs by guesswork wastes money. LafeberVet's technical PDF treats meter use as the cleanest way to confirm real UVI at reptile level — it can prevent both premature bulb changes and underpowered setups, and it pays for itself quickly for keepers running multiple enclosures or sensitive species.
