...
picks:
  - rank: 1
    label: "LOWER THE TENSION — PHEROMONE"
    name: "FELIWAY MultiCat 30-Day Calming Diffuser Starter Kit"
    brand: "FELIWAY"
    score: 8.2
    price: "$24.99"
    image: "https://m.media-amazon.com/images/I/515v9k-QeoL._SL500_.jpg"
    asin: "B01AVHPFDS"
    authoritySources:
      - outlet: "FELIWAY (Amazon product listing, MultiCat Starter Kit)"
        url: "https://www.amazon.com/dp/B01AVHPFDS"
        stat: "helps reduce common signs of tension between cats such as conflict, fighting, chasing, and blocking; drug-free and non-sedating; each diffuser covers an area up to 700 sq ft"
        supports: "spec"
        accessed: "2026-07-11"
      - outlet: "ASPCA (multi-cat introduction and feline welfare consensus)"
        stat: "cat introductions should be gradual, and lowering ambient stress supports a smoother pairing — a diffuser is a supportive layer, not a substitute for the slow process"
        supports: "general"
        accessed: "2026-07-11"
    keyFeatures:
    ...
    verdict: "Use case: the resident cat whose settled routine is about to be disrupted, where lowering the baseline tension a few days ahead smooths every step that follows. It is the supporting layer, not the lever — the slow scent-first process is still what does the real work, and a diffuser only makes the room quieter while it happens."

  - rank: 2
    label: "VERTICAL TERRITORY — SO NEITHER CAT IS TRAPPED"
    name: "FDW 54\" Cat Tree Tower (multi-level)"
    brand: "FDW"
    score: 8.0
    price: "$38.99"
    image: "https://m.media-amazon.com/images/I/41GZdo6rzaL._SL500_.jpg"
    asin: "B0D2HMV3S6"
    authoritySources:
      - outlet: "FDW (Amazon product listing, 54\" Cat Tree Tower)"
        url: "https://www.amazon.com/dp/B0D2HMV3S6"
        stat: "multi-level cat tree with perches, ladders, a cozy condo, natural sisal scratching posts, and soft cat beds and enclosed houses"
        supports: "spec"
        accessed: "2026-07-11"
      - outlet: "Feline welfare consensus on vertical territory"
        stat: "vertical space and multiple elevated escape routes help defuse conflict between cats sharing a home"
        supports: "general"
        accessed: "2026-07-11"
    keyFeatures:
    ...
    verdict: "The trade-off is plain: you give up the heft and polish of a premium tower and get, cheaply, the one thing an introduction actually needs — height and escape routes so neither cat is ever trapped on the floor. Buy it to add a second climbing option, anchor it well, and treat a single tower as the first piece of a vertical plan rather than the whole of it."

  - rank: 3
    label: "SEPARATE WATER — NO SHARED BOWL"
    name: "Cat Water Fountain Stainless Steel 74oz"
    brand: "GIOTOHUN"
    score: 7.9
    price: "$19.99"
    image: "https://m.media-amazon.com/images/I/415JCwXaE6L._SL500_.jpg"
    asin: "B0DDPYHHFX"
    authoritySources:
      - outlet: "GIOTOHUN (Amazon product listing, Stainless Steel Cat Water Fountain)"
        url: "https://www.amazon.com/dp/B0DDPYHHFX"
        stat: "74 oz (2.2 L) SUS 304 stainless steel cat water fountain with faucet and fountain running-water modes and a pump rated under 25 dB"
        supports: "spec"
        accessed: "2026-07-11"
      - outlet: "Feline health consensus on hydration"
        stat: "running water encourages many cats to drink more, supporting urinary-tract health"
        supports: "general"
        accessed: "2026-07-11"
    keyFeatures:
  ...
  - rank: 4
    ...
    asin: "B0GFMGBC79"
    authoritySources:
      - outlet: "TEVILA (Amazon product listing, Stainless XL High-Sided)"
        url: "https://www.amazon.com/dp/B0GFMGBC79"
        stat: "22.8 x 15 x 10.2 in stainless steel litter box, holds up to 20 L of litter, non-porous surface that won't absorb odor, ideal for multi-cat households; scoop included"
        supports: "spec"
        accessed: "2026-07-11"
      - outlet: "AAHA/AAFP (feline behavior and welfare consensus)"
        stat: "the general resource guideline for multi-cat homes is one litter box per cat plus one extra, placed in separate locations"
        supports: "general"
        accessed: "2026-07-11"
    keyFeatures:
    ...
    verdict: "The resource rule is not a suggestion — one box per cat plus one, in separate locations, is the concrete step that keeps litter from becoming contested ground during an introduction. This box earns its place as the separated third station: large, odor-resistant, and easy to enter. Choose a lower-entry box instead for a kitten or a stiff senior."

  - rank: 5
    label: "THE BARRIER — GRADUAL, SUPERVISED CONTACT"
    name: "Full Metal Freestanding Gate with Cat Door"
    brand: "Klarana"
    score: 8.1
    price: "$87.99"
    image: "https://m.media-amazon.com/images/I/514vb3zRKNL._SL500_.jpg"
    asin: "B0F5H9WTFN"
    authoritySources:
      - outlet: "Klarana (Amazon product listing, Full Metal Freestanding Gate)"
        url: "https://www.amazon.com/dp/B0F5H9WTFN"
        stat: "32 in tall, 80 in extra-wide freestanding full-metal gate with an independent cat door 7.9 in high by 7.1 in wide for separation between animals; freestanding or wall-fixed"
        supports: "spec"
        accessed: "2026-07-11"
      - outlet: "ASPCA / Cornell Feline Health Center (feline aggression and introduction consensus)"
        stat: "cats should be allowed to see and smell each other through a barrier before sharing space, and supervised sessions should end before conflict escalates"
        supports: "general"
        accessed: "2026-07-11"
    keyFeatures:
    ...
    verdict: "Use case: the visual-contact phase, once scent-swapping and door-feeding have gone smoothly and both cats need to see each other before sharing space. The see-through gate lets you run short, distance-controlled sessions and stop each one while everyone is still calm. Supervise every session, use the wall-fixed option on slick floors, and slow down if the sessions keep ending badly."

  - rank: 6
    label: "SEPARATE FEEDING STATIONS"
    name: "Elevated Cat Bowls (raised stainless, set of 2)"
    brand: "Meowgod"
    score: 7.8
    price: "$22.99"
  ...
  - rank: 7
    ...
    verdict: "Keep one in the newcomer's room from the first hour, because a cat that controls its own hiding is far calmer than one that is cornered. It is a decompression base, not a divider — the closed door and the gate do the separating, and this simply gives the new cat somewhere that is unmistakably its own to retreat to and choose when to engage."

comparison:
  rows:
    - label: "Role in the introduction"
      values: ["Lowers ambient tension", "Vertical escape territory", "Separate water source", "The separated extra litter box", "Controlled visual contact", "Separate feeding stations", "The newcomer's retreat"]
...
methodology:
  formula: "PetPal Gear Score = (Expert Consensus × 0.35) + (Introduction Fit × 0.25) + (Safety / Welfare Design × 0.20) + (Value × 0.20)"
  factors:
    - name: "Expert Consensus"
      weight: 35
      definition: "Synthesized from several expert sources. These are ASPCA multi-cat introduction and feline aggression guidance, the AAHA/AAFP feline behavior and life-stage guidelines, the Cornell Feline Health Center, the Merck Veterinary Manual, and manufacturer documentation. The PetPal Gear Score is a composite of expert opinion. PetPalHQ does not run a testing lab."
    - name: "Introduction Fit"
      weight: 25
      definition: "How directly the item advances a slow, scent-first introduction on duplicated resources. That could mean lowering tension, adding escape routes, or giving each cat its own food, water, litter, and retreat. What matters is that job, not how it performs as a standalone product."
    - name: "Safety / Welfare Design"
      weight: 20
      definition: "Alignment with documented welfare guidance. That means the one-box-per-cat-plus-one resource rule and large, easily entered box geometry. It also means safe barriers for supervised contact, vertical escape routes, and defensible hiding places."
    - name: "Value"
      weight: 20
      definition: "Cost relative to the item's role in the introduction. Consumables such as diffuser refills and fountain filters are weighed against how much conflict risk the item removes."
...
bottomLine:
  ...
  - "Keep the world bigger than the conflict. Vertical space and multiple escape routes defuse most tension, and for households with the space, [setting up a catio so both cats get safe outdoor time](/guides/how-to-set-up-a-catio-outdoor-cat-enclosure-2026) adds shared, low-competition territory once the cats are getting along."
...
The introduction itself moves in a deliberate order. The newcomer starts in its own room, with its own food, water, litter, and a place to hide, so the two cats never meet before they are ready. Scent comes before sight: you trade bedding or rub a cloth from one cat onto the other, so each learns the other's smell as an ordinary part of the home. Then good things happen near that scent — both cats fed on opposite sides of the closed door — before you ever progress to seeing each other through a barrier. Only after brief, calm visual contact do you allow short supervised together-time, always ended before anyone stiffens or stares, and the barrier and the separate resources stay in place until both cats are consistently relaxed. Nothing is merged early. The pace is set by the more cautious cat, not the calendar.
