...
picks:
  ...
  - rank: 4
    ...
    body: |
      ...
      The KGIMORLEX product page describes a lightweight aluminum frame with adjustable height, width, and length. It lists soft padded harness straps and all-terrain wheels for indoor and outdoor use, in sizes from small through large. It sells for $197.89 on Amazon as of September 2, 2026, down from Amazon's $210.00 typical price, and the page frames it as support for elderly, injured, or recovering dogs. That is a fraction of what a premium-brand quad setup costs, since the Walkin' Wheels route starts at the $529.00 rear cart before the front attachment is added on top.
...
comparison:
  rows:
    ...
    - label: "Weight range"
      values: ["70–180 lb, 20–22-in leg", "XS–XL tiers; Large = 21–26-in hindquarters", "Title says 11–44 lb; size attribute says 18–39 lb, 8–11-in leg", "Small through large — size-dependent", "Size-dependent per listing variant"]
...
A: By other sellers. All five picks in this guide are listed by third-party storefronts on Amazon rather than by Amazon itself, which is normal in a small specialist category like this one. The Best Friend Mobility FML Elite ships from an Amazon warehouse and carries Amazon's free 30-day return window; the other four ship from the seller and run their own 30-day return terms. Read those terms on the listing before ordering, because a wheelchair that arrives in the wrong size is the most likely reason you will need them.
