  ...
  - rank: 1
    ...
    authoritySources:
      - outlet: "Bulk Reef Supply"
        url: "https://www.bulkreefsupply.com/4-stage-75gpd-plus-ro-di-system-bulk-reef-supply.html"
        stat: "Deionization resin is the final stage of the RODI system and will polish your water down to 0 TDS. Minimum Water Pressure: 50 PSI"
        claim: "The 4 Stage Value Plus is rated for 75 gallons per day, polishes water to 0 TDS at the DI stage, and needs at least 50 PSI of feed pressure to run well."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "Bulk Reef Supply"
        url: "https://www.bulkreefsupply.com/content/post/best-brs-rodi-systems"
        stat: "Tap water often contains chlorine, unwanted nutrients, and other contaminants that can cause problems fast."
        claim: "Reef keepers use an RO/DI system because tap water carries chlorine, nutrients, and contaminants that an RO/DI unit removes to give a consistent 0 TDS base."
        supports: "general"
        accessed: "2026-06-22"
      - outlet: "Amazon listing"
        url: "https://www.amazon.com/dp/B0DQLSCW8P?tag=petpalhq08-20"
        stat: "$249.99 — Bulk Reef Supply 4 Stage Value Plus 75 GPD RO/DI Reverse Osmosis Deionization System"
        claim: "Current Amazon street price for the BRS 4 Stage Value Plus 75 GPD RO/DI system."
        supports: "value"
        accessed: "2026-06-22"
    aliases:
    ...
    verdict: "The default RO/DI system for most reef tanks. Buy it for the complete, beginner-friendly package — dual TDS meter, flush kit, and 0 TDS DI stage — and accept the modest 75 GPD output and the 50 PSI feed-pressure requirement. If your home pressure is low, budget for a booster pump."

  - rank: 2
    label: "BEST HIGH-OUTPUT"
    name: "AquaFX Barracuda 100 GPD RO/DI System"
    brand: "AquaFX"
    score: 8.8
    price: "$209.99"
    image: "https://m.media-amazon.com/images/I/516IeMlHHlL._SL500_.jpg"
    asin: "B0043FYJ8M"
    authoritySources:
      - outlet: "AquaFX (via Top Shelf Aquatics)"
        url: "https://topshelfaquatics.com/products/barracuda-rodi-unit-standard-100-gpd-aquafx"
        stat: "Stage 1 - AquaFX Premium 1-micron Sediment Filter; Stage 2 - AquaFX Chlorine Guzzler Carbon Block Pre-filter; Stage 3 - AquaFX TFC RO Membrane (made in the USA); Stage 4 - AquaFX Mixed Bed Color Indicating Zero TDS DI resin"
        claim: "The Barracuda 100 GPD runs a four-stage train — 1-micron sediment, Chlorine Guzzler carbon block, USA-made TFC RO membrane, and a color-indicating mixed-bed DI resin that produces 0 TDS water."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "Bulk Reef Supply"
        url: "https://www.bulkreefsupply.com/content/post/best-brs-rodi-systems"
        stat: "Tap water often contains chlorine, unwanted nutrients, and other contaminants that can cause problems fast."
        claim: "A 4-stage RO/DI unit like the Barracuda removes the chlorine, nutrients, and contaminants BRS warns are in tap water, leaving a consistent base for reef water."
        supports: "general"
        accessed: "2026-06-22"
      - outlet: "Amazon listing"
        url: "https://www.amazon.com/dp/B0043FYJ8M?tag=petpalhq08-20"
        stat: "$209.99 — AquaFX Barracuda 100 GPD RO/DI System"
        claim: "Current Amazon street price for the AquaFX Barracuda 100 GPD RO/DI system."
        supports: "value"
        accessed: "2026-06-22"
    aliases:
      - "AquaFX Barracuda"
    ...
    verdict: "The high-output pick for a mid-to-large reef or a keeper who mixes salt water in big batches. Buy it for the 100 GPD rate and the color-indicating DI resin, confirm you are getting the standard trim, and remember the rated output assumes decent feed pressure and temperature."

  - rank: 3
    label: "BEST MAX-OUTPUT"
    name: "LiquaGen 6 Stage 150 GPD RO/DI Reef System"
    brand: "LiquaGen"
    score: 9.0
    price: "$219.99"
    image: "https://m.media-amazon.com/images/I/41TT7dp-HbL._SL500_.jpg"
    asin: "B01MS9NM9N"
    authoritySources:
      - outlet: "LiquaGen"
        url: "https://liquagen.com/products/copy-of-6-stage-elementary-75-gpd-ro-di-water-filter-system"
        stat: "Makes up to 150 gallons of zero TDS water per day; Dual DI canisters add an extra layer of protection; perfect RO/DI system for almost any type of city water treatment process, including those with high levels of chlorine and chloramines"
        claim: "LiquaGen rates this 6-stage system to make up to 150 gallons of zero-TDS water per day, uses dual DI canisters for added capacity, and positions it for city water high in chlorine and chloramines."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "Bulk Reef Supply"
        url: "https://www.bulkreefsupply.com/content/post/best-brs-rodi-systems"
        stat: "Tap water often contains chlorine, unwanted nutrients, and other contaminants that can cause problems fast."
        claim: "A high-output RO/DI unit like the LiquaGen removes the chlorine, nutrients, and contaminants BRS warns are in tap water, giving a consistent 0 TDS base for high-volume reef use."
        supports: "recommendation"
        accessed: "2026-06-22"
      - outlet: "Amazon listing"
        url: "https://www.amazon.com/dp/B01MS9NM9N?tag=petpalhq08-20"
        stat: "$219.99 — LiquaGen 6 Stage 150 GPD RO/DI Reef System"
        claim: "Current Amazon street price for the LiquaGen 6 Stage 150 GPD RO/DI reef system."
        supports: "value"
        accessed: "2026-06-22"
    aliases:
      - "LiquaGen 6 Stage"
    ...
    verdict: "The max-output pick for large reef systems or anyone who wants to fill a storage drum quickly. Buy it for the 150 GPD ceiling and the dual-DI capacity, but treat 150 GPD as a best-case rate, plan for the extra waste water, and budget for two DI resins instead of one."

  - rank: 4
    label: "BEST VALUE"
    name: "AquaticLife Twist-In 100 GPD 4-Stage RO/DI Unit"
    brand: "AquaticLife"
    score: 8.3
    price: "$129.99"
    ...
    authoritySources:
      - outlet: "AquaticLife"
        url: "https://aquaticlife.com/products/twist-in-4-stage-reverse-osmosis-deionization-system"
        stat: "The new Twist-In media cartridge design makes filter changes simple, easy and clean – no tools required and no mess! ... TWIST-IN MIXED BED COLOR CHANGING RESIN DEIONIZATION CARTRIDGE: Replace filter when resin changes color completely to amber."
        claim: "The AquaticLife Twist-In 100 GPD runs a 4-stage train (sediment, carbon block, RO membrane, deionization) with tool-free twist-in cartridges and a color-changing mixed-bed DI resin that turns amber when spent."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "Bulk Reef Supply"
        url: "https://www.bulkreefsupply.com/content/post/best-brs-rodi-systems"
        stat: "Tap water often contains chlorine, unwanted nutrients, and other contaminants that can cause problems fast."
        claim: "A 4-stage RO/DI unit like the AquaticLife Twist-In removes the chlorine, nutrients, and contaminants BRS warns are in tap water, giving a consistent 0 TDS base for a budget reef setup."
        supports: "general"
        accessed: "2026-06-22"
      - outlet: "Amazon listing"
        url: "https://www.amazon.com/dp/B01HRDE170?tag=petpalhq08-20"
        stat: "$129.99 — AQUATICLIFE Twist-in 100 GPD 4-Stage Ro Unit (Sediment, Carbon Block, Membrane, Deionization)"
        claim: "Current Amazon street price for the AquaticLife Twist-In 100 GPD 4-Stage RO/DI unit, with the listing title confirming the 100 GPD rating and four-stage train."
        supports: "value"
        accessed: "2026-06-22"
    aliases:
      - "AquaticLife Twist-In"
      - "the AquaticLife 100"
      - "the Twist-In RO/DI"
    keyFeatures:
...
methodology:
  ...
  factors:
    - name: "Purification Performance"
      weight: 35
      definition: "How thoroughly the system strips contaminants and polishes water toward 0 TDS, based on the membrane and the deionization stage. We synthesize this from manufacturer specs on the RO membrane and DI resin and from Bulk Reef Supply's framing that the DI stage is what brings RO water down to 0 TDS for a clean reef base. The Pure Water Score is a composite of published specs and expert consensus, not a measurement — PetPalHQ does not run a testing lab."
    - name: "Build Quality & Components"
      weight: 25
      definition: "Quality and serviceability of the housings, bracket, fittings, and instrumentation. We credit included monitoring (inline TDS meters, glycerin pressure gauges), durable brackets, USA-made membranes where documented, and standard versus proprietary cartridge formats."
    - name: "Production Capacity"
      weight: 20
      definition: "Rated gallons-per-day output relative to a tank's likely top-off and salt-mix demand. GPD is a production rate that depends on feed pressure and water temperature, so we treat a unit's rated figure as a ceiling and weight it against realistic demand rather than rewarding the biggest number outright."
    - name: "Maintenance & Serviceability"
      weight: 12
      definition: "How easy the system is to live with — cartridge changes, flush kits, dual-DI capacity, and visual exhaustion cues like color-changing resin. We reward designs that make membrane and resin changes painless, since the most common owner failure is leaving spent media in too long."
    - name: "Value"
      weight: 8
      definition: "Purchase price relative to capability and the longer-run cost of replacement membranes and resin. This is the smallest weight in the score by design, so a strong-value pick never outranks a better-purifying system on the score alone — value breaks ties, it does not drive the ranking."
...
sources:
  ...
  verifiedDate: "2026-06-22"
  authorBio: "Nicholas Miles is the chief editor of PetPalHQ. The picks above are editorial synthesis of manufacturer specifications and reef-keeping expert consensus — PetPalHQ does not run a testing lab and did no first-hand product testing. The Pure Water Score is a composite of published specs and expert opinion, not a measurement. Sources are cited by name throughout."
...
An RO/DI system makes the water a reef tank is built on. RO/DI stands for reverse osmosis plus deionization. Water is forced through a membrane that rejects most dissolved solids, then through a deionization resin that polishes what is left down to 0 TDS — zero total dissolved solids. That clean base matters because tap water carries chlorine, chloramine, nutrients like phosphate, and trace metals that feed algae and stress sensitive corals and invertebrates. Starting from 0 TDS water removes that guesswork from every top-off and salt mix.

The hard part is not the brand. It is matching daily output to how much water you actually use, on the feed pressure your home can supply. GPD is a production rate, not a fixed yield. A 150 GPD label assumes adequate pressure and warm-ish feed water, so a cold, low-pressure line will produce far less and waste more. Every system below was chosen by editorial synthesis of manufacturer specifications and reef-keeping consensus from Bulk Reef Supply. PetPalHQ does not run a testing lab, and every spec claim traces to a named source.

## Frequently Asked Questions

**Q: Do I really need RO/DI water for a reef tank?**
...
**Q: What does GPD actually mean, and will a 150 GPD unit make 150 gallons a day?**
A: GPD is gallons per day, the membrane's rated production rate. It is a ceiling, not a promise. Real output depends on feed pressure and water temperature, so a cold, low-pressure line will produce well under the rated number. Read the rating as best-case. If you need a guaranteed high output, check your home pressure first and consider a booster pump.

**Q: How much feed pressure does an RO/DI system need?**
A: Most units want a solid household pressure to hit their rated output. Bulk Reef Supply lists a minimum of 50 PSI for its 4-stage system. Below that, the membrane under-produces and wastes more water. If your pressure is marginal or you are on a well, a booster pump brings the membrane up to spec. Always check the unit's stated minimum before buying.

**Q: What is the DI stage, and why do reef keepers insist on it?**
