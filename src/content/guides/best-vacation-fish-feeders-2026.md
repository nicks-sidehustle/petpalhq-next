...
comparison:
  ...
  rows:
    - ["Eheim Feed-Air", "$69.99", "Programmable auto-feeder", "Regular travel, trusted brand", "8.6"]
...
methodology:
  ...
  factors:
    ...
    - name: "Value"
      weight: 10
      definition: "Price relative to reliability and control, not the lowest sticker. The budget Aoyar scores highest on raw value for covering the core job cheaply, while the premium Eheim earns its price through brand reliability and humidity protection. Value is judged against how much you are risking: for a prized tank on a long trip, the cheapest feeder is rarely the best value."
