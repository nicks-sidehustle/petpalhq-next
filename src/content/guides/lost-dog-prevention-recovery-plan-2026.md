...
picks:
  ...
  - rank: 3
    ...
    body: |
      ...
      Price and the honest catch, together: it lists and currently sells at $79.00 as of our August 10, 2026 check, but the hardware is only half the cost. The subscription is mandatory — plans start around $5 a month on annual billing, roughly $248 over three years per the roundup — and the AVMA line is the reason a tracker exists at all: "the microchip is not a GPS device and cannot track your animal if it gets lost." A chip reunites a dog after a stranger finds it; a tracker shows you where a moving dog is right now. They do different jobs, and neither replaces the other.
