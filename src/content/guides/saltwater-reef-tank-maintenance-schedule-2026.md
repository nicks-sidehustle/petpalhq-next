...
picks:
  - rank: 1
    label: "DAILY — TOP-OFF AUTOMATION"
    name: "Tunze Osmolator 3 (3154) Automatic Top-Off System"
    brand: "Tunze"
    score: 8.6
    price: "$249.99"
    ...
    authoritySources:
      - outlet: "Tunze (Amazon product listing, Osmolator 3 3154)"
        ...
        supports: "spec"
        accessed: "2026-07-16"
      - outlet: "Reef-keeping education consensus (Bulk Reef Supply's maintenance curriculum and the reef community)"
        stat: "evaporation removes only fresh water and leaves salt behind, so salinity climbs unless fresh RO/DI top-off water replaces the loss, which makes an automatic top-off the way to automate the single most frequent maintenance task"
        supports: "general"
        accessed: "2026-07-16"
    keyFeatures:
  ...
  - rank: 2
    ...
    score: 8.5
    price: "$249.99"
    image: "https://m.media-amazon.com/images/I/51sXlBlOLvL._SL500_.jpg"
    asin: "B0DQLSCW8P"
    ...
    authoritySources:
      - outlet: "Bulk Reef Supply (Amazon product listing, 4 Stage Value Plus 75 GPD RO/DI)"
        ...
        supports: "spec"
        accessed: "2026-07-16"
      - outlet: "Published reef water-chemistry targets"
        stat: "reef water must be free of the silicates, phosphates, and dissolved solids that tap water carries, and the DI resin that removes the last of them is exhausted once the built-in TDS meter reads above zero, which is the signal to replace it"
        supports: "general"
        accessed: "2026-07-16"
    keyFeatures:
    ...
    verdict: "Make reef water rather than pouring it, because tap water's silicates and phosphates are the algae you will otherwise fight all year. This four-stage unit polishes water to a DI finish and tells you when the resin is spent with its own TDS meter — plan for the wastewater line and the consumable filters."

  - rank: 3
    label: "WEEKLY WATER — REEF SALT MIX"
    name: "Instant Ocean Reef Crystals Reef Salt (160 gal)"
    brand: "Instant Ocean"
    score: 8.4
    price: "$79.97"
    image: "https://m.media-amazon.com/images/I/41-z1oN-eFL._SL500_.jpg"
    asin: "B000HCLNQG"
    ...
    authoritySources:
      - outlet: "Instant Ocean (Amazon product listing, Reef Crystals Reef Salt)"
        ...
        accessed: "2026-07-16"
      - outlet: "Reef-keeping education consensus (Bulk Reef Supply's maintenance curriculum and the reef community)"
        stat: "a weekly partial water change of roughly 10 to 15 percent with RO/DI-mixed salt water is the consensus baseline for reef tanks, replenishing trace elements and diluting waste at the same time"
        supports: "general"
        accessed: "2026-07-16"
    keyFeatures:
    ...
    verdict: "Mix reef salt with RO/DI for the weekly change, and give each batch time to dissolve, aerate, and match the tank's salinity before it goes in. Reef Crystals adds back the calcium and trace elements a reef spends, and a big box keeps the per-change cost down — just treat it as the recurring consumable it is."

  - rank: 4
    label: "WEEKLY CHEMISTRY — TEST KIT"
    name: "Red Sea Reef Foundation Pro Test Kit"
    brand: "Red Sea"
    score: 8.3
    price: "$87.99"
    image: "https://m.media-amazon.com/images/I/410tomG+86L._SL500_.jpg"
    asin: "B004FUJ5NE"
    ...
    authoritySources:
      - outlet: "Red Sea (Amazon product listing, Reef Foundation Pro Test Kit)"
        ...
        accessed: "2026-07-16"
      - outlet: "Published reef water-chemistry targets"
        stat: "commonly published reef ranges sit near 8 to 9 dKH alkalinity, 400 to 450 ppm calcium, and 1250 to 1350 ppm magnesium, with alkalinity moving fastest of the three and therefore tested most often — weekly at minimum, twice weekly for many reefers"
        supports: "general"
        accessed: "2026-07-16"
    keyFeatures:
  ...
  - rank: 5
    label: "TEST-THEN-DOSE — TWO-PART SOLUTION"
    name: "ESV B-Ionic Calcium Buffer System (2-Gallon)"
    brand: "ESV"
    score: 8.2
    price: "$52.99"
    image: "https://m.media-amazon.com/images/I/41ix5Z1N1bL._SL500_.jpg"
    asin: "B001EHCDL2"
    ...
    authoritySources:
      - outlet: "ESV (Amazon product listing, B-Ionic Calcium Buffer System)"
        ...
        accessed: "2026-07-16"
      - outlet: "Reef-keeping education consensus (Bulk Reef Supply's maintenance curriculum and the reef community)"
        stat: "test-then-dose discipline means measuring alkalinity and calcium first and dosing only to replace measured consumption, keeping the two components balanced rather than dosing blind on a schedule alone"
        supports: "general"
        accessed: "2026-07-16"
    keyFeatures:
  ...
  - rank: 6
    label: "TEST-THEN-DOSE — DOSING PUMP"
    name: "Kamoer X1 PRO-T Programmable WiFi Dosing Pump"
    brand: "Kamoer"
    score: 8.1
    price: "$135.45"
    image: "https://m.media-amazon.com/images/I/31Ndostp7JL._SL500_.jpg"
    asin: "B09NN4XBQ8"
    ...
    authoritySources:
      - outlet: "Kamoer (Amazon product listing, X1 PRO-T Dosing Pump)"
        ...
        accessed: "2026-07-16"
      - outlet: "Reef-keeping education consensus (Bulk Reef Supply's maintenance curriculum and the reef community)"
        stat: "splitting a daily dose into many small automated additions holds calcium and alkalinity steadier than one large manual dose, which is why a dosing pump wins on consistency once a reef's demand is high enough to matter"
        supports: "general"
        accessed: "2026-07-16"
    keyFeatures:
    ...
    body: |
      ...
      Where it fits the schedule: this is the automation layer over test-then-dose. It does not replace testing. It executes the dose the testing defines. As a reef's coral demand grows, the daily requirement for calcium and alkalinity climbs. Delivering it in small, frequent, scheduled amounts keeps the numbers flat instead of spiking after each manual dose. The pump is calibrated so its output is known, then set to deliver the measured daily demand. The weekly test confirms the setting is still right. When a single head is not enough for a mixed dosing plan, [our roundup of the best reef dosing pumps](/guides/best-reef-dosing-pumps-2026) covers multi-head units and controllers. Confirm current price and availability before buying, since dosing hardware pricing shifts often.
  ...
  - rank: 7
    ...
    authoritySources:
      - outlet: "Aquatic Experts (Amazon product listing, Felt Filter Socks 200 Micron)"
        ...
        accessed: "2026-07-16"
      - outlet: "Reef-keeping education consensus (Bulk Reef Supply's maintenance curriculum and the reef community)"
        stat: "a filter sock traps detritus mechanically but must be swapped or cleaned every 3 to 7 days before the trapped waste breaks down and re-pollutes the water it was meant to clean"
        supports: "general"
        accessed: "2026-07-16"
    keyFeatures:
    ...
    body: |
      ...
      Where it fits the schedule: this is the every-few-days task, and it lives in the sump alongside the skimmer and return pump. The 200-micron felt catches particles fine enough to clear the water visibly. But the catch is a countdown. Trapped detritus starts breaking down within days, releasing the nitrate and phosphate it was meant to remove. So the sock is swapped or cleaned every 3 to 7 days rather than left to load up. The two-pack is deliberate: one sock is in service while its partner is washed and dried, so the swap is never blocked on laundry. Because socks live in the sump, [our roundup of the best reef aquarium sumps and refugiums](/guides/best-reef-aquarium-sumps-refugiums-2026) is the place to see where they fit the whole filtration picture.
    ...
    verdict: "Run filter socks in the sump and swap them every few days, because their whole value depends on the swap happening before the catch breaks down. The reusable felt polishes water cheaply and the two-pack keeps a clean one ready — just confirm they fit your sump's cup, not a Red Sea tray."

  - rank: 8
    label: "WEEKLY SALINITY CHECK"
    name: "Agriculture Solutions Salinity Refractometer"
    brand: "Agriculture Solutions"
    score: 7.9
    price: "$17.99"
    image: "https://m.media-amazon.com/images/I/51aV-gr4oQL._SL500_.jpg"
    asin: "B018LRO1SU"
    ...
    authoritySources:
      - outlet: "Agriculture Solutions (Amazon product listing, Salinity Refractometer)"
        ...
        accessed: "2026-07-16"
      - outlet: "Published reef water-chemistry targets"
        stat: "reef salinity is held near 35 ppt, or a specific gravity of 1.025 to 1.026, and kept steady rather than chased, because stability matters more than hitting a perfect number and a refractometer calibrated against RO/DI zero is how that reading is verified"
        supports: "general"
        accessed: "2026-07-16"
    keyFeatures:
  ...
  - rank: 9
    ...
    authoritySources:
      - outlet: "Python (Amazon product listing, No Spill Clean and Fill 50 ft)"
        ...
        accessed: "2026-07-16"
      - outlet: "Reef-keeping education consensus (Bulk Reef Supply's maintenance curriculum and the reef community)"
        stat: "on a reef the Python drains old water to the sink cleanly, but the refill must be pre-mixed RO/DI salt water at matched salinity and temperature, never tap water run straight from the faucet"
        supports: "general"
        accessed: "2026-07-16"
    keyFeatures:
    ...
    verdict: "Use the Python to drain water-change day painlessly, and repurpose its fill side to move pre-mixed salt water rather than tap. Listed at $99.99 and often discounted, it removes the bucket work that makes weekly changes slip — just never refill a reef straight from the faucet."

  - rank: 10
    label: "MONTHLY GLASS/PUMP SERVICE"
    name: "Aqueon Magnetic Algae Scraper (Medium)"
    brand: "Aqueon"
    score: 7.7
    price: "$14.95"
    image: "https://m.media-amazon.com/images/I/41V1++-ZUwL._SL500_.jpg"
    asin: "B004BFGE1Y"
    ...
    authoritySources:
      - outlet: "Aqueon (Amazon product listing, Magnetic Algae Scraper Medium)"
        ...
        accessed: "2026-07-16"
      - outlet: "Reef-keeping education consensus (Bulk Reef Supply's maintenance curriculum and the reef community)"
        stat: "monthly service also means soaking wavemaker and return-pump wet-sides in a vinegar or citric-acid solution to strip the coralline and calcium deposits that slowly throttle a reef's flow"
        supports: "general"
        accessed: "2026-07-16"
    keyFeatures:
    ...
    verdict: "Scrape the glass monthly from outside, and pair it with the less visible monthly job of soaking pumps to clear deposits. This magnet keeps the panes clear without disturbing corals — just keep grit out from under the pad, because one trapped grain is all it takes to scratch the glass."

comparison:
  rows:
    - label: "Stage in the schedule"
      values: ["Daily top-off", "Weekly water", "Weekly water", "Weekly chemistry", "Test then dose", "Test then dose", "Every 3–7 days", "Weekly check", "Water-change day", "Monthly service"]
    - label: "How often it runs"
      values: ["Continuously", "Batch weekly", "Mixed per batch", "Weekly minimum", "As tests show", "Small daily doses", "Swapped every few days", "Weekly", "Weekly to biweekly", "Monthly"]
    - label: "What it does"
...
methodology:
  ...
  factors:
    ...
    - name: "Schedule Fit"
      weight: 25
      definition: "How directly the item serves a recurring maintenance task on its own cadence — the daily top-off, the weekly water change and chemistry test, the every-few-days sock swap, and the monthly service — rather than how it performs as a standalone product ranked against rivals."
    - name: "Reef-Chemistry / Water-Quality Design"
      weight: 20
      definition: "Alignment with reef-upkeep principles — stable salinity near 35 ppt, balanced alkalinity, calcium, and magnesium held by test-then-dose discipline, RO/DI-based water, and detritus kept out of the water column. Consistency is valued over chasing perfect numbers."
    - name: "Value"
      weight: 20
      definition: "Cost relative to the item's role in the schedule, including the ongoing consumables each one carries — salt, reagents, two-part, DI resin, and filter socks. This bench is the equipment cost, not the recurring cost of running a reef."

whenNotToBuy: |
  A reef-tank maintenance schedule keeps a healthy tank healthy. It does not rescue a tank already in crisis, and it is the wrong first purchase for anyone whose tank is not yet built and cycled. If you are still choosing a tank, plumbing a sump, and cycling live rock, this bench comes later. The day-0 build is a different project, and [our beginner's guide to starting a saltwater reef tank](/guides/how-to-start-a-saltwater-reef-tank-for-beginners-2026) is the place to start there. The gear below assumes a tank that is already wet, stocked, and stable, and its whole job is to keep it that way.
