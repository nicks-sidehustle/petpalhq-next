...
We kept the list to four because each pick represents a distinct, defensible delivery format rather than the same chemistry in three packages. Across the guidance we surveyed, the flea-and-tick category sorts cleanly into collar, kill-on-contact topical, repellent topical, and fast oral knockdown — so one strong representative of each is more useful than four overlapping spot-ons. The PetPal Gear Score weights expert consensus and effectiveness most heavily, but it is format-aware: a same-day oral rescue is scored on the rescue job, not penalized for failing to last a month it was never meant to last. Every product on this page was verified live on Amazon — right listing, in stock, current price — on the date in the frontmatter.
...
The most important safety fact in this guide is about cats, not dogs. K9 Advantix II and other permethrin-based topicals are toxic to cats — a cat can be poisoned by grooming a freshly treated dog or simply lying against it before the application dries. In a household with both species, a permethrin product is only safe if you can reliably keep the treated dog away from the cat until it is fully dry, and if you cannot, you should choose a permethrin-free option such as the Seresto collar or Frontline Plus instead. This is not a cautious footnote; it is a genuine cause of feline poisoning, and it is the reason every mention of K9 Advantix II in this guide carries the same warning.
...
**Q: Why is K9 Advantix II dangerous around cats?**

A: Because it contains permethrin, which is toxic to cats even though it is safe for dogs at the labeled dose. A cat can be poisoned by grooming a freshly treated dog, by lying against the wet application site, or by close contact before it dries. This is a real and well-documented cause of feline poisoning, not a theoretical risk. If you have both a dog and a cat and cannot reliably keep the treated dog separated until the product is fully dry, you should choose a permethrin-free option such as the Seresto collar or Frontline Plus. Never apply any permethrin product directly to a cat.
