...
keywords:
  - "reef aquarium sump"
  - "reef sump and refugium"
  - "Eshopps RS-75 sump"
  - "IceCap 15 reef sump"
  - "Fiji Cube reef sump"
  - "saltwater sump baffles"
  - "refugium macroalgae sump"
  - "reef sump equipment chamber"
  - "best reef sump 2026"
...
picks:
  - rank: 1
    ...
    score: 9.3
    price: "$262.85"
    image: "https://m.media-amazon.com/images/I/31U1Yvw2eNL._SL500_.jpg"
    asin: "B00798Z5WY"
    authoritySources:
      - outlet: "Eshopps"
        url: "https://www.eshopps.com/product/rs-75/"
        stat: "Dimensions 20x10x16 in; recommended tank size 10-75 gal; total water volume 12 US gallons; skimmer chamber 6x9.5 in; return pump chamber 5x9.5 in; 4 in filter sock; max flow 600 GPH"
        claim: "The RS-75 is a 20 by 10 by 16 inch reef sump rated for 10 to 75 gallon tanks, holding about 12 gallons of water, with a 6 by 9.5 inch skimmer chamber and a 5 by 9.5 inch return chamber."
        supports: "spec"
        accessed: "2026-06-25"
      - outlet: "Bulk Reef Supply"
        url: "https://www.bulkreefsupply.com/rs-75-reef-sump-4th-gen-eshopps-ob.html"
        stat: "20 L x 10 W x 16 H in; recommended 10-75 gallons; 12 US gallons total water volume; one 4-inch filter sock included; max flow rate 600 GPH; 1x 1 in bulkhead drain"
        claim: "Bulk Reef Supply lists the RS-75 at 20 by 10 by 16 inches with a single 1 inch bulkhead drain, an included 4 inch filter sock, and a 600 GPH maximum flow rate."
        supports: "spec"
        accessed: "2026-06-25"
    aliases:
      - "Eshopps RS-75"
    ...
    body: |
      ...
      The chamber layout is the real draw. Water enters one chamber, passes a 4 inch filter sock, and then splits toward the [skimmer](/guides/best-protein-skimmers-saltwater-reef-2026) and refugium zones before it reaches the [return pump](/guides/best-aquarium-return-pumps-2026). Eshopps lists a 6 by 9.5 inch skimmer chamber alongside a 5 by 9.5 inch return chamber, and a 600 GPH maximum flow gives most nano-to-mid reef tanks plenty of room to work.
  ...
  - rank: 2
    label: "BEST EQUIPMENT LAYOUT"
    name: "IceCap 15 Reef Sump V2"
    brand: "IceCap"
    score: 9.1
    price: "$294.51"
    image: "https://m.media-amazon.com/images/I/31NNg2tBLpL._SL500_.jpg"
    asin: "B0GKJ9B22P"
    authoritySources:
      - outlet: "CoralVue"
        url: "https://www.coralvue.com/icecap-15-reef-sump"
        stat: "Footprint 15in x 15in x 14in; for aquariums ranging from 10-80 gallons; single 4in filter sock holder; constructed to adapt with adjustable baffles and probe holders and room for skimmers, heaters, return pumps and reactors"
        claim: "IceCap's CoralVue page lists a 15 by 15 by 14 inch footprint rated for 10 to 80 gallon tanks, with a 4 inch filter sock holder, adjustable baffles, and probe holders."
        supports: "spec"
        accessed: "2026-06-25"
      - outlet: "Premium Aquatics"
        url: "https://premiumaquatics.com/products/icecap-15-reef-sump-v2"
        stat: "15in x 15in x 14in for 10-80 gallons; Two 1in drains plus emergency drain holder; 4in filter sock holder fits Klir Di-4; skimmer section 9.4in x 9.6in; return pump section 4.7in x 9.4in; Triple Probe Holder; Twin Heater Holder; V2 removed the freshwater reservoir and increased return space"
        claim: "Premium Aquatics lists the V2 with two 1 inch drains plus an emergency drain holder, a triple probe holder, a twin heater holder, and a 4 inch sock holder that fits the Klir Di-4."
        supports: "spec"
        accessed: "2026-06-25"
    aliases:
      - "IceCap 15 V2"
    ...
    verdict: "The pick for reefers who want a home for every probe, heater, and sock, because the IceCap 15 V2 trades raw water volume for the deepest set of equipment holders in this comparison."
  ...
  - rank: 3
    ...
    authoritySources:
      - outlet: "Fiji Cube"
        ...
        accessed: "2026-06-25"
      - outlet: "Bulk Reef Supply"
        url: "https://www.bulkreefsupply.com/fiji-20-advanced-reef-sump-2nd-gen-fiji-cube.html"
        stat: "20 L x 15 W x 16 H in; 20 gallon water capacity; recommended 60-100 gallons; full cast acrylic with full top support brace; two 4 in holders for floss box and filter sock; removable heater holder, test probe holder and dosing holes; removable auto top-off float valve holder; skimmer 14.2x8.1, refugium 5.2x5.8, return 8.1x5.8"
        claim: "Bulk Reef Supply lists the Fiji-20 at 20 by 15 by 16 inches holding 20 gallons, rated for 60 to 100 gallon tanks, with a removable heater holder, probe holder, dosing holes, and an auto-top-off float valve holder."
        supports: "spec"
        accessed: "2026-06-25"
    aliases:
      - "Fiji-20"
    ...
    verdict: "The premium, refugium-ready build for a mid-to-large reef, because the Fiji-20 wins on cast-acrylic quality and bundled gear, so long as you budget for the higher price and the larger footprint."

  - rank: 4
    label: "BEST FOR LARGER TANKS"
    name: "Eshopps RS-100 Reef Sump"
    brand: "Eshopps"
    score: 8.6
    price: "$469.53"
    ...
    verdict: "The right step-up only when your display is genuinely large, because the RS-100 sump adds water volume and a bigger footprint that would be overkill on a nano or mid reef tank."

  - rank: 5
    label: "BEST DEDICATED REFUGIUM"
    name: "Eshopps Refugium Cube Nano"
    brand: "Eshopps"
    score: 7.9
    price: "$318.09"
    ...
    verdict: "A compact, refugium-first sump rather than a do-everything box, because the Cube Nano is the pick only when nutrient export and pod culture are your real goal instead of all-in-one filtration."

comparison:
  rows:
    - label: "Best-fit use case"
      values: ["All-round 3-chamber value sump", "Most equipment holders and drains", "Premium cast-acrylic build", "Larger tanks, more water volume", "Refugium-first compact sump"]
    - label: "Footprint (L x W x H)"
      values: ["20 x 10 x 16 in (Eshopps/BRS)", "15 x 15 x 14 in (CoralVue)", "20 x 15 x 16 in (BRS)", "~24 x 12 x 16 in (RS-100 line)", "Nano cube footprint"]
    - label: "Rated tank size"
      values: ["10-75 gal", "10-80 gal", "60-100 gal", "~75-125 gal (RS-100 line)", "~10-35 gal refugium"]
    - label: "Sump water volume"
...
A: Chamber layout matters more because it decides what the sump can actually run. A good design keeps the skimmer, refugium, and return pump in separate zones so they do not fight each other. Baffles trap micro-bubbles before water reaches the return pump, and probe and heater holders keep your gear both tidy and safe. A huge sump with a poor layout is harder to use than a smaller one with smart chambers, because size only adds water buffer while layout adds real function.

**Q: Are acrylic sumps prone to leaking?**

A: A well-built acrylic sump rarely leaks, which is exactly why seam quality and brand track record carry weight in the rubric here. Cast acrylic with a top brace resists bowing over years of use, and the real leak risk is usually the plumbing rather than the box itself. Most drips start at a loose bulkhead, a bad union, or a sock overflow instead of a failed seam, so test a new sump with fresh water for a full day before you trust it on a stocked reef.

**Q: Can I add a sump to a tank that isn't reef-ready?**

A: Sometimes you can, but it takes real work, because a sump needs water to drain down and then pump back up, so the tank requires either a drilled overflow or a hang-on overflow box. A reef-ready tank already has the holes and an overflow built in, while a standard tank must be drilled or fitted with an external overflow, which adds both cost and some risk. If you are not comfortable plumbing a drain, plan that step carefully before you buy any sump on this page.
