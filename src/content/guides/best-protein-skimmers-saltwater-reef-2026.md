...
picks:
  - rank: 1
    ...
    score: 9.0
    price: "$326.85"
    image: "https://m.media-amazon.com/images/I/41sk5wnU1nL._SL500_.jpg"
    asin: "B003TQ7Z8W"
    authoritySources:
      - outlet: "Reef Octopus / CoralVue"
        url: "https://www.coralvue.com/classic-110int-protein-skimmer"
        stat: "In-sump skimmer for aquariums up to 130 Gallons; Air Draw: 420lph / 15SCFH"
        claim: "The Classic 110-INT is rated as an in-sump needle-wheel skimmer for aquariums up to 130 gallons, running the Aquatrance 1000s pinwheel pump."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "Bulk Reef Supply"
        url: "https://www.bulkreefsupply.com/content/post/md-2021-03-protein-skimmer-types-installation-and-how-to-maintain-them"
        stat: "In-sump skimmers are the most popular type of skimmers. They sit inside the water within a sump in a cabinet under the main aquarium display."
        claim: "In-sump skimmers like the Classic 110-INT are the most popular and widely recommended type for reef tanks with a sump."
        supports: "general"
        accessed: "2026-06-22"
      - outlet: "Amazon listing"
        url: "https://www.amazon.com/dp/B003TQ7Z8W?tag=petpalhq08-20"
        stat: "$326.85 — Reef Octopus Classic 110-INT, in-sump needle-wheel skimmer rated up to 130 gal"
        claim: "Current Amazon street price for the Classic 110-INT in-sump needle-wheel skimmer."
        supports: "value"
        accessed: "2026-06-22"
    aliases:
    ...
    verdict: "The default in-sump skimmer for a normally stocked 100-130 gallon reef with a sump. Buy it for the proven pump and easy tuning, accept the break-in period, and do not buy it if you have no sump."
  ...
  - rank: 2
    ...
    score: 8.7
    price: "$199.99"
    image: "https://m.media-amazon.com/images/I/31fKDicsfDL._SL500_.jpg"
    asin: "B079TJG15W"
    authoritySources:
      - outlet: "IceCap / CoralVue"
        url: "https://www.coralvue.com/icecap-k1-130-protein-skimmer"
        stat: "Light: 140 gallons; Medium: 100 gallons; Heavy: 80 gallons. Pump: EVair 400 Pinwheel Pump, 8watts, Air Draw: 400lph / 14scfh"
        claim: "The K1-130 is rated 140 gal light / 100 gal medium / 80 gal heavy bioload on an efficient 8W EVair 400 DC pinwheel pump."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "Bulk Reef Supply"
        url: "https://www.bulkreefsupply.com/content/post/how-to-choose-a-protein-skimmer-and-mistakes-to-avoid"
        stat: "it's always better to undersize a skimmer than to get something too big because an oversized skimmer simply won't work"
        claim: "Match the skimmer to the manufacturer's bioload rating and err toward undersizing — the K1-130's three bioload ratings make that easy."
        supports: "recommendation"
        accessed: "2026-06-22"
      - outlet: "Amazon listing"
        url: "https://www.amazon.com/dp/B079TJG15W?tag=petpalhq08-20"
        stat: "$199.99 — IceCap K1-130, in-sump skimmer with 8W DC pump rated 80-140 gal by bioload"
        claim: "Current Amazon street price for the K1-130 in-sump DC skimmer."
        supports: "value"
        accessed: "2026-06-22"
    aliases:
      - "IceCap K1-130"
    ...
    verdict: "The value in-sump skimmer for 80-140 gallon reef tanks where running cost and footprint matter. You give up the controllability of the dedicated DC models, but you get an efficient modern pump at a price the premium tier cannot touch."

  - rank: 3
    label: "BEST FOR NANO / IN-TANK"
    name: "Tunze 9004 Comline DOC Skimmer"
    brand: "Tunze"
    score: 8.9
    price: "$199.99"
    ...
    authoritySources:
      - outlet: "Tunze"
        ...
        stat: "Recommended, depending on tank load, from 60 to 250 liters (15 to 65 USgal.); air bubbles with a diameter of between .1 and .3 mm (.004\" - .012\"); Energy consumption: 4 W"
        claim: "The 9004 Comline is rated 60-250 L (15-65 US gal) by load, generating very fine 0.1-0.3 mm bubbles at just 4W, and can run as a stand-alone in-tank skimmer."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "Bulk Reef Supply"
        url: "https://www.bulkreefsupply.com/content/post/brs-recommended-nano-protein-skimmers"
        stat: "Using a protein skimmer on a nano aquarium is a great way to maintain a more stable environment"
        claim: "A nano/in-tank skimmer like the Tunze 9004 helps keep a small reef's parameters more stable."
        supports: "recommendation"
        accessed: "2026-06-22"
      - outlet: "Amazon listing"
  ...
  - rank: 4
    label: "BEST FOR LARGE / HEAVY-BIOLOAD REEF"
    ...
    authoritySources:
      ...
      - outlet: "Bulk Reef Supply"
        ...
        claim: "On a large heavy-bioload system, match the display to the manufacturer's heavy-bioload rating — the Regal's 100-gal heavy figure is the number to trust."
        supports: "recommendation"
        accessed: "2026-06-22"
      - outlet: "Amazon listing"
        url: "https://www.amazon.com/dp/B00TJ2NM96?tag=petpalhq08-20"
        stat: "$716.09 — Reef Octopus Regal 150SSS, space-saver cone skimmer with controllable VarioS pump"
        claim: "Current Amazon street price for the Regal 150SSS space-saver skimmer."
        supports: "value"
        accessed: "2026-06-22"
    aliases:
    ...
    verdict: "The skimmer for large, heavily stocked reef systems that have outgrown a mid-size unit. Buy it for the controllable capacity your bioload actually needs, and skip it entirely if your heavy-bioload volume is under ~100 gallons."

  - rank: 5
    label: "BEST BUDGET / HANG-ON-BACK"
    name: "Bubble Magus MiniQ Hang-On-Back Nano Protein Skimmer"
    brand: "Bubble Magus"
    score: 8.1
    price: "$79.99"
    image: "https://m.media-amazon.com/images/I/410eyNzEY4L._SL500_.jpg"
    asin: "B0D928LBJZ"
    authoritySources:
      - outlet: "Bubble Magus"
        url: "https://bubble-magus.net/products/bubble-magus-miniq-internal-nano-protein-skimmer-for-marine-saltwater-aquarium-up-to-20-gallons"
        stat: "Up to 19.8 gallons; DC Needle Brush Pump (2W); Can run on USB ports, phone chargers, or power banks for flexibility during emergencies"
        claim: "The MiniQ is rated for tanks up to ~20 gallons on a 2W DC needle-brush pump and can run from a USB power bank during an outage."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "Bulk Reef Supply"
        url: "https://www.bulkreefsupply.com/content/post/brs-recommended-nano-protein-skimmers"
        stat: "Using a protein skimmer on a nano aquarium is a great way to maintain a more stable environment"
        claim: "A small nano skimmer like the MiniQ can help keep a 20-gallon AIO reef's parameters more stable."
        supports: "general"
        accessed: "2026-06-22"
      - outlet: "Amazon listing"
        url: "https://www.amazon.com/dp/B0D928LBJZ?tag=petpalhq08-20"
        stat: "$79.99 — Bubble Magus MiniQ, hang-on/internal nano skimmer rated up to ~20 gal"
        claim: "Current Amazon street price for the Bubble Magus MiniQ nano skimmer."
        supports: "value"
        accessed: "2026-06-22"
    aliases:
      - "Bubble Magus MiniQ"
    ...
    verdict: "The budget hang-on/internal skimmer for a small AIO reef where price and footprint decide the purchase. Buy it if you want nutrient export on a tight budget and will tune it patiently; skip it if disciplined water changes already keep your nano stable."

comparison:
  rows:
    - label: "Form factor & mount"
      values: ["In-sump needle-wheel", "In-sump DC", "In-tank stand-alone (no sump)", "In-sump space-saver cone", "Hang-on / internal nano"]
    - label: "Rated capacity (by bioload)"
      values: ["Up to 130 gal", "140 / 100 / 80 gal (light/med/heavy)", "15-65 US gal (60-250 L)", "210 / 160 / 100 gal (light/med/heavy)", "Up to ~20 gal"]
    - label: "Pump & air draw"
...
sources:
  ...
  verifiedDate: "2026-06-22"
  authorBio: "Nicholas Miles is the chief editor of PetPalHQ. The picks above are editorial synthesis of manufacturer specifications and reef-keeping expert consensus — PetPalHQ does not run a testing lab. The Reef-Ready Skimmer Score is a composite of published specs and expert opinion, not a measurement. Sources are cited by name throughout."
