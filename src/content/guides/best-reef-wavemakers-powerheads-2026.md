...
keywords:
  ...
  - "Tunze 6040 wavemaker"
  - "Jebao MOW-9"
  - "controllable reef powerhead"
  - "gyre wavemaker reef tank"
  - "Maxspect XF330 gyre"
  - "reef tank flow turnover rate"
...
featured: false
image: "/images/guides/best-reef-wavemakers-powerheads-2026.png"
heroImage: "/images/guides/best-reef-wavemakers-powerheads-2026.png"
products: []
...
picks:
  - rank: 1
    label: "BEST MID-TIER REEF POWERHEAD"
    name: "AquaIllumination AI Nero 3 Submersible Wavemaker (2,000 GPH)"
    brand: "AquaIllumination"
    score: 9.0
    price: "$179.99"
    image: "https://m.media-amazon.com/images/I/41ppS+O+BaL._SL500_.jpg"
    asin: "B08KZT7SMQ"
    authoritySources:
      - outlet: "AquaIllumination"
        url: "https://www.aquaillumination.com/products/nero"
        stat: "Flow Rate: 2,000 gph (7,570 lph); Tank Size: 2.5-60+ gallons; Glass Thickness: 0.5 in. (13 mm)"
        claim: "AquaIllumination rates the Nero 3 at 2,000 GPH max for tanks from 2.5 to 60-plus gallons, controlled via the Mobius app (also myAI compatible)."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "Bulk Reef Supply"
        url: "https://www.bulkreefsupply.com/nero-3-powerhead-2000-gph-aqua-illumination.html"
        stat: "Max Flow - 2000 GPH; Power Consumption: (variable) 20W @ 120VAC max; can be programmed down to 1%, putting this particular model right around 20-40gph; Ideal for Aquariums 5-60 Gallons; The Nero 3 can be conveniently controlled with the free MyAI or Mobius app"
        claim: "Bulk Reef Supply lists the Nero 3 at 2,000 GPH max with variable power to 20W, adjustable down to roughly 20-40 GPH, ideal for 5-60 gallon tanks, with MyAI/Mobius app control."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "Amazon listing"
        url: "https://www.amazon.com/dp/B08KZT7SMQ?tag=petpalhq08-20"
    ...
    verdict: "The default controllable powerhead for a typical 30-60 gallon mixed reef. Buy it for the wide adjustable range and app control, run two for varied flow on a larger SPS tank, and step up to the Nero 5 if your display is past about 60 gallons."

  - rank: 2
    label: "BEST BUDGET CONTROLLABLE"
    name: "Jebao MOW-9 Smart Wave Maker (LCD Controller, Magnetic Base)"
    brand: "Jebao"
    score: 8.3
    price: "$82.99"
    image: "https://m.media-amazon.com/images/I/31Tlo465LTS._SL500_.jpg"
    asin: "B099QY6K3P"
    authoritySources:
      - outlet: "jzxonline"
        url: "https://jzxonline.com/collections/wavemaker/products/jebao-mow-series-wavemakermow-5-mow-9-mow-16-mow-22"
        stat: "MOW-9: Voltage: DC 24V, Watts: 23, Max l/h: 9000, Dimension: 66x 82mm, Tank Size: 60-100, Tank Thickness: ≤12mm"
        claim: "The Jebao MOW-9 is a 24V DC wavemaker rated 9,000 L/H (about 2,377 GPH) at 23W, with a magnetic mount for glass up to 12 mm."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "D-D The Aquarium Solution"
        url: "https://www.theaquariumsolution.com/product/8337/410"
        stat: "The super quiet motor uses sine wave technology for reliable and quiet operation. Multiple wave patterns are available to choose from by using the controller or App interface. These include Classic, Sine, Random and Constant modes. MOW-9: 9000 L/H; MOW-9: 24V, 23W"
        claim: "Jecod/Jebao documents the MOW line as using a sine-wave motor with Classic, Sine, Random and Constant modes via an LCD dual-interface controller or the Jebao Aqua app."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "Amazon listing"
        url: "https://www.amazon.com/dp/B099QY6K3P?tag=petpalhq08-20"
    ...
    verdict: "The budget controllable wavemaker for a reefer who wants programmable flow and wave modes without premium-tier spend. Buy it knowing noise and long-term durability are the trade-offs; if silence and build matter more than price, move up to the Tunze 6040."

  - rank: 3
    label: "BEST PREMIUM (UP TO ~130 GAL)"
    name: "Tunze Turbelle NanoStream 6040 (HUB Edition)"
    brand: "Tunze"
    score: 9.1
    price: "$233.99"
    image: "https://m.media-amazon.com/images/I/41x44alOkoL._SL500_.jpg"
    asin: "B0DNKHHPWT"
    authoritySources:
      - outlet: "Tunze (via Bulk Reef Supply)"
        url: "https://www.bulkreefsupply.com/turbelle-nanostream-6040-hub-edition-tunze.html"
        stat: "Flow Rate: 53-1190 GPH; Power Consumption: 1.5-13W; Compact, Smart & Silent Flow for Aquariums up to 132 Gallons; includes the Turbelle Controller 7020, allowing for performance adjustments and access to the Tunze HUB; Fish Care Function, which briefly moves the propeller every 20 seconds when the pump is in standby"
        claim: "The Tunze 6040 HUB Edition is rated 53-1190 GPH at just 1.5-13W for aquariums up to 132 gallons, with the Turbelle Controller 7020, TUNZE HUB Wi-Fi access, and a fish-care function."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "Bulk Reef Supply"
        url: "https://www.bulkreefsupply.com/content/post/faq-19-how-much-water-flow-do-i-need-in-my-reef-aquarium-52-faq"
        stat: "In general we recommend 20 to 40 times your display tank's volume. The higher target goal will be a good starting point for SPS dominant tanks, and the lower better for soft corals and LPS. In most cases you will want to split that target goal between two or more powerheads to create natural flow patterns in the tank."
        claim: "Bulk Reef Supply recommends roughly 20-40x tank-volume turnover, split across two or more pumps, which is why a controllable low-draw pump like the 6040 suits varied flow."
        supports: "recommendation"
        accessed: "2026-06-22"
      - outlet: "Amazon listing"
        url: "https://www.amazon.com/dp/B0DNKHHPWT?tag=petpalhq08-20"
    ...
    verdict: "The premium controllable wavemaker for nano-to-mid reefs up to about 130 gallons where efficiency, silence, and build quality matter. Buy it for the Tunze engineering and lowest power draw here; run two or more on a large SPS tank rather than expecting one to carry it."

  - rank: 4
    label: "BEST FOR LARGER REEFS (40-100 GAL)"
    name: "AquaIllumination AI Nero 5 Submersible Wavemaker (3,000 GPH)"
    brand: "AquaIllumination"
    score: 9.0
    price: "$269.99"
    image: "https://m.media-amazon.com/images/I/41SVGD5SxPL._SL500_.jpg"
    asin: "B0CW3Q72FM"
    authoritySources:
      - outlet: "AquaIllumination"
        url: "https://www.aquaillumination.com/products/nero"
        stat: "Flow Rate: 3,000 gph (11,356 lph); Power Consumption: Variable, 30W max; Tank Size: 40-100+ gallons; Glass Thickness: 0.63 in. (16 mm)"
        claim: "AquaIllumination rates the Nero 5 at 3,000 GPH max with variable power to 30W, for tanks from 40 to 100-plus gallons, on glass up to 0.63 inch (16 mm)."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "Bulk Reef Supply"
        url: "https://www.bulkreefsupply.com/nero-5-powerhead-3000-gph-aqua-illumination.html"
        stat: "Max Flow - 3000 GPH; Ideal for Aquariums 40-100 Gallons; pushes water in a wide pattern that can move foods, detritus, or other free-floating particles around without blasting corals directly; around 15° of movement, you can angle the Nero 5 to direct flow"
        claim: "Bulk Reef Supply lists the Nero 5 at 3,000 GPH max, ideal for 40-100 gallon tanks, pushing a wide coral-friendly pattern with about 15 degrees of angle adjustment."
        supports: "spec"
        accessed: "2026-06-22"
      - outlet: "Amazon listing"
        url: "https://www.amazon.com/dp/B0CW3Q72FM?tag=petpalhq08-20"
  ...
  - rank: 5
    ...
    authoritySources:
      ...
      - outlet: "CoralVue"
        ...
        accessed: "2026-06-22"
      - outlet: "Amazon listing"
        url: "https://www.amazon.com/dp/B07PNRY68T?tag=petpalhq08-20"
...
sources:
  ...
  verifiedDate: "2026-06-22"
  authorBio: "Nicholas Miles is the chief editor of PetPalHQ. The picks above are editorial synthesis of manufacturer and distributor specifications and reef-keeping expert consensus — PetPalHQ does not run a testing lab and did not test these pumps first-hand. The Reef Flow Score is a composite of published specs and expert opinion, not a measurement, and price is not one of its weighted factors. Sources are cited by name throughout."
...
A wavemaker, or powerhead, is the pump that creates the in-tank water movement a reef needs. Corals are not fed by the filter; they are fed by flow that carries food and oxygen to them and sweeps waste and detritus off them and back into suspension where the skimmer and filter can remove it. The hard part is not picking a brand. It is sizing and placing flow correctly, because reef flow is measured by turnover and pattern, not by a single pump's biggest GPH number. Reef-keeping educators generally target roughly 20 to 40 times your display volume per hour in total flow, split across two or more pumps for natural, varied movement — more for SPS-dominant tanks, less for soft corals and LPS. Every product below was chosen by editorial synthesis of manufacturer and distributor specifications and reef-keeping flow education from Bulk Reef Supply — PetPalHQ does not run a testing lab, and every claim traces to a named source.

## Frequently Asked Questions

**Q: How much flow does my reef tank actually need?**
