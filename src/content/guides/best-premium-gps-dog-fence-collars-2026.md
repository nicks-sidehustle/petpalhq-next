...
comparison:
  rows:
    ...
    - label: "Accuracy claim (manufacturer)"
      values: ["Under 5 ft, 151-satellite True Location", "Within 2 ft, Precision+ L1 + L5 + ground stations", "AccuGuard: GPS + motion + AI (no published figure)"]
    - label: "Dog size"
