...
There is a complication in running that math, and it is worth naming plainly: Halo does not publish its Pack Membership rates. We fetched Halo's plans page on August 10, 2026 — it names Bronze, Silver, and Gold, describes what each tier includes, and advertises discounted annual and 2-year billing, but shows no dollar figure for any of them. Pricing appears only at checkout or after account login. So the honest comparison is not "$524 plus a known fee versus $999" but "$524 plus an undisclosed fee versus $999 that never changes," and a shopper cannot close that gap without getting Halo's rate in writing first. The SpotOn and the PetSafe Guardian have knowable final costs of $999.00 and $399.99; the Halo does not. Our [GPS containment total-cost comparison](/guides/best-gps-dog-containment-total-cost-comparison-2026) shows the full 1-, 3-, and 5-year table for every system whose rate is published, including the Garmin Alpha 300i and a GPS tracker for scale, and separates the subscriptions that are genuinely required from the ones that are merely sold.
