...
const networkSites = [
  {
    name: "SmartHomeExpert",
    url: "https://smarthomeexpert.com",
  ...
  {
    name: "DeskSetupHQ",
    url: "https://desksetuphq.com",
    tagline: "Expert Desk Setup & WFH Reviews",
    description: "Monitors, chairs, desks, keyboards, and productivity gear for home offices.",
    icon: "💻",
    category: "Home Office",
  },
  {
    name: "ChristmasGiftHQ",
    url: "https://christmasgifthq.com",
    tagline: "Expert Gift Guides & Holiday Reviews",
    description: "Curated gift guides for everyone on your list — from tech to toys to experience gifts.",
    icon: "🎁",
    category: "Gifts",
  },
  {
    name: "FoodieGearHQ",
    url: "https://foodiegearhq.com",
    tagline: "Expert Kitchen & Cooking Gear Reviews",
    description: "Cookware, appliances, knives, and kitchen tools for home cooks and food enthusiasts.",
    icon: "🍳",
    category: "Kitchen",
  },
  {
  ...
  {
    name: "OneClickBuy",
    url: "https://oneclickbuy.com",
    tagline: "Quick-Buy Guides for Everyday Essentials",
    description: "Fast, no-fluff buying guides for everyday products you need without the research rabbit hole.",
    icon: "🛒",
    category: "General",
  },
];
