 ...
 *
 * Templates in this file build HTML from data that can originate outside our
 * own copy (e.g. a visitor-supplied name), so interpolating a raw value would
 * let it write markup — including an anchor — into mail we send from our own
 * domain.
 */
