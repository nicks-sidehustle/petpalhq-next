...
const DARK_COPY = /Last Amazon read|Current Amazon price|List price ·|Current price ·|data-price-stamp|Amazon&#x27;s price may vary|Amazon's price may vary/;
let darkSurfaces = 0;
let livePriceEls = 0;
