...
const TOPPICK_FIXTURE: Array<{ slug: string; name: string; asin: string; why: string }> = [
  ...
  { slug: 'best-dog-treadmills-large-breed-2026', name: 'Kolmmeo Dog Treadmill for Large Dogs with Manual Brake & Timer, 18-Inch Usable Width', asin: 'B0DR2RSYTZ', why: 'the surviving Kolmmeo slatmill — renamed 2026-09-02 to the listing\'s own published title after the unpublished "Up to 500 lbs" claim was cut, and the dead M-size sibling B0CT682ZHG was dropped from the roster in the same edit; the ASIN pin is unchanged and suppression still follows current state' },
];
