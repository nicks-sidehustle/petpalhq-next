...
The W4 brief includes CLAUDE.md §3–§5 verbatim. Where w4-verify's Dark-card check, Instrument checks 2 and 5, and Deal-price-as-MSRP checks disagree, CLAUDE.md governs (owner 2026-09-24). Until the pricing render PRs land, the rendered snapshot figure and a missing "checked" stamp are recorded in BLAST RADIUS and are not grounds for HOLD (CLAUDE.md Known gaps). Its verdict is posted as a PR comment ending with the literal line:
